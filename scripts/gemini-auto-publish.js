...
5. 전체 4대 섹션 구성 및 순서 (순서 변경 불가):
    - 섹션 1 (id: "sec_1", category: "1. 해외 증시 마감 현황", icon: "TrendingUp"):
      다우 지수(Dow), S&P 500, 나스닥(Nasdaq), 러셀 2000(소형주), 필라델피아 반도체 지수(SOX), MSCI 한국 지수 ETF(EWY), 야간 선물 등 7대 지수의 '실제 최근 영업일 마감 수치'와 등락률(%), 원인을 정확히 검색하여 1줄로 작성.
     * text 형식 규칙: "{지수명}: {실제마감수치} ({등락률}%) - {원인 및 마감 동향 요약}"
     * 절대 임의의 숫자를 지어내지 말고 검색된 실제 종가를 작성할 것.
     * source는 각각 "다우", "S&P500", "나스닥", "러셀 2000(소형주)", "필라델피아 반도체 지수", "한국물", "선물"로 지정.
