...
2. [좋은 예시 vs 나쁜 예시 대조]:
   ...
   - ⭕ 정보 밀도 보강: "미 연방 판사의 미 국방부가 국가안보 위험을 이유로 AI 스타트업 앤스로픽을 공급망 블랙리스트에 올린 조치에 대한 절차적 하위 위법 판결"

   - ❌ 단순 제목 축약: "미 식품의약국(FDA)의 코로나19 백신 승인"
   - ⭕ 정보 밀도 보강: "미 식품의약국(FDA)의 올가을 유행 우세종으로 지목된 신규 변이(XFG) 표적 개량 코로나19 백신의 긴급 사용 승인"

   - ❌ 단순 제목 축약: "도널드 트럼프 대통령의 온타리오 호수 개명 서명"
   - ⭕ 정보 밀도 보강: "도널드 트럼프 대통령의 미국·캐나다 국경에 위치한 오대호 중 하나인 온타리오 호수를 '아메리카 호수'로 공식 변경하는 행정명령 서명"
