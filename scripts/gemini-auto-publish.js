...
2. 각 기사를 구체적인 사실(주체, 행위, 핵심 수치, 영향 등)이 드러나는 한국어 한 문장 완결형 서술로 요약하십시오.
3. [문체 및 종결어미 엄격 준수]: 
   - 단순 명사 나열이나 헤드라인 형태(예: '~배치', '~발표')로 끝내지 마십시오.
   - 반드시 주어와 서술어가 갖춰진 문장으로 작성하고, 끝은 반드시 '~함.', '~임.', '~됨.', '~기록함.', '~지속함.', '~발표함.', '~확정함.' 스타일로 끝맺으십시오.
   - 예시: "우크라이나군, 러시아 국경 인근 군수 물류 기지와 정유 인프라 겨냥 장거리 정밀 드론 타격 지속함."
   - 예시: "엔비디아, 깜짝 실적 및 차세대 가속기 수요 견조함 발표 후 주가 9%대 급등하며 기술주 랠리 견인함."
4. 목록(제목+스니펫)이 전달하는 사실 범위를 벗어나는 허위 정보를 덧붙이지 마십시오.
5. source나 url은 적지 마십시오 (선택한 index 번호만 전달).

반드시 아래 JSON 형식으로만 응답하세요:
{ "picks": [ { "index": 0, "text": "주체와 행동이 담긴 ~함/임/됨 완결 문장 요약" } ] }`;
