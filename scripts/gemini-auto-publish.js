...
5. 전체 4대 섹션 구성 및 순서 (순서 변경 불가):
   - 섹션 1 (id: "sec_1", category: "**1. 해외 증시 마감 현황**", icon: "TrendingUp"):
     다우 지수, S&P 500, 나스닥, 러셀 2000, 필라델피아 반도체 지수, MSCI 한국 지수 ETF, 야간 선물 지수와 등락률(%)을 명시 (각각 source: "다우", "S&P500", "나스닥", "소형주", "반도체", "한국물", "선물")
     * text 작성 예시: "다우 지수: 53,343.40 (-0.22%)", "필라델피아 반도체 지수: 11,992.46 (-4.98%)"
   ...
   - 섹션 4 (id: "sec_4", category: "**4. 오늘의 시황 요약**", icon: "TrendingUp"):
     미국 증시 마감 분석, 국내 증시 수급 영향(외국인/기관 동향), 당일 공략 섹터 및 실전 대응 전략 3~4개 항목 작성 (~함/임 종결, source: "시황 분석")
6. 팩트 기반 원칙:
